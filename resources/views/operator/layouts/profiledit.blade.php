        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-header">
                    @foreach ( $admins as $p )
                        <form method="POST" action="/operator/editprofil/{nik}">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <table width="auto" border="0" cellpadding="5">
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-danger" name="batal" value="BATAL" onclick="window.location.href='/operator/profil'">
