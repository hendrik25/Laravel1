...
@section('container')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Edit Riwayat Cuti Karyawan</h1>
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    {{-- <div class="card-header"> --}}
                        @foreach ( $cutis as $p )
                        <form method="POST" action="/operator/riwayatupdate/{{ $p->id }}">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <table width="auto" border="0" cellpadding="5">
                                        ...
                                        <tr>
                                            ...
                                            <td width="350px"><input type="date" name="tgl_awal" class="form-control" value="{{ $p->tgl_awal }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><label class="col-form-label">TANGGAL AKHIR CUTI</label></td>
                                            <td width="350px"><input type="date" name="tgl_akhir" class="form-control" value="{{ $p->tgl_akhir }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><label class="col-form-label">KETERANGAN</label></td>
                                            <td><textarea name="keterangan" class="form-control" rows="3" value="{{ $p->keterangan }}">{{ $p->keterangan }}</textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="col-sm-6">
                                    <table width="auto" border="0" cellpadding="5">
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-danger" name="batal" value="BATAL" onclick="window.location.href='/operator/riwayat'">
