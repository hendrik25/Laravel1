                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <table width="auto" border="0" cellpadding="5">
                                        <tr>
                                            <td><label class="col-form-label">no_hp</label></td>
                                            <td width="350px"><input type="text" name="no_hp" class="form-control
                                                @error('no_hp') is-invalid @enderror"  value="{{ old('no_hp') }}" autofocus>
                                                @error('no_hp')
                                    ...
                                    <table width="auto" border="0" cellpadding="5">
                                        ...
                                        <tr>
                                            ...
                                            <td><textarea name="alamat" class="form-control
                                                @error('alamat') is-invalid @enderror" rows="2" ></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="date" name="tgl_masuk" class="form-control
                                                @error('tgl_masuk') is-invalid @enderror">
                                            </td>
                                        </tr>
                                    </table>
                                </div>
